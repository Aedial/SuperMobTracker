...
public class GuiIconButton extends GuiButton {
    ...
    public void drawButton(@Nonnull Minecraft mc, int mouseX, int mouseY, float partialTicks) {
        ...
        drawRect(this.x, this.y - 1, this.x + this.width, this.y, borderColor); // Top border
        drawRect(this.x, this.y + this.height, this.x + this.width, this.y + this.height + 1, borderColor); // Bottom border
        drawRect(this.x - 1, this.y, this.x, this.y + this.height, borderColor); // Left border
        drawRect(this.x + this.width, this.y, this.x + this.width + 1, this.y + this.height, borderColor); // Right border
        ...
        drawScaledCustomSizeModalRect(this.x, this.y, 0, 0, 16, 16, this.width, this.height, 16, 16);
